...
export name='Rafael Aparecido Ferrari Filho'
export email="rafaelferrarifilho1234@gmail.com"
export repositorio="https://github.com/rafael274/Atividade_PAM.git";
